...
if __name__ == '__main__':
    ...
    for data_name in data_names:
        ...
        for _, data_row in data_df.iterrows():
            ...
            sent = data_row.iloc[0]
            label = data_row.iloc[-1]
    ...
    results_df.to_excel('./data/analysis/{}.xlsx'.format(save_name)) 
    totals_df.to_excel('./data/analysis/{}_sum.xlsx'.format(save_name))
