...
def augment_sentence(sentence: str) -> str:
    aug = aug_flow.Sequential([
       ...
       word_aug.ContextualWordEmbsAug(model_path='bert-base-uncased', action="insert", device="cuda"),
...
if __name__ == "__main__":
    ...
    augment_data_dict(data, max_len, 1.5)
    save_as_tsv(data, './data/aug_train_data8.tsv')
